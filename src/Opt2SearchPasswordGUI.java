...
public class Opt2SearchPasswordGUI extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Opt2SearchPasswordGUI(PasswordManager passwordManager) {
		...
		optionlbl = new JLabel("Search A Passowrd");
		...
		confirmbtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Password searchResult = passwordManager.getPasswordData(titletxt.getText());
